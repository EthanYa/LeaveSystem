	 ...
	 $(function(){
		   ...
		   // alert( $("#counter").val());
			...
			('<div class="col-sm-2"><label>'+'姓名 </label>'+
				...
				'<div class="col-sm-2">'+
				'<label>開始時間</label>'+
					'<input class="form-control" name="begin'+counter+'" id="begintime'+counter+'"  type="text" readonly="readonly" />'+ 
				'</div>'+
				'<div class="col-sm-2">'+
				'<label>結束時間</label>'+
					'<input class="form-control" name="end'+counter+'" type="text" id="endtime'+counter+'" readonly="readonly"  />'+ 
				'</div>'+
				'<div class="col-sm-2">'+
				'<label>請假時數</label>'+
