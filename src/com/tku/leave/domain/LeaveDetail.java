...
public class LeaveDetail {
	...
	public LeaveDetail(long detailId, long mainId, long classId,
			...
			long userId, String name, String className, String approveStatus,
			String mail) {
		super();
	...
	public String toString() {
		return "LeaveDetail [detailId=" + detailId + ", mainId=" + mainId
				...
				+ ", reason=" + reason + ", userId=" + userId + ", name="
				+ name + ", className=" + className + ", approveStatus="
				+ approveStatus + ", mail=" + mail + "]";
	}
